  ...
  return (
    <div>
      ...
      <Box
        ...
        autoComplete="off"
      >
        <Typography variant='h3' sx={{m:3}}>Let me know about You!..</Typography>
        <form onSubmit={handleSubmit}>
          ...
          <Button onClick={() => navigate("/")} variant='contained' sx={{ m: 1, width: 150 }} >Home</Button>
          <Button type="Submit" variant='contained' sx={{ m: 1, width: 150 }} color="success">Next</Button>
        </form>
      </Box>
